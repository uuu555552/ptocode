...
async def stream_code(websocket: WebSocket):
    ...
    if SHOULD_MOCK_AI_RESPONSE:
        ...
        try:
            ...
            completion = await new_generate.get_chat_completion(
                    prompt_messages,
            ...
            error_message = (
                "Contact the developer for resolution."
            )
            return await throw_error(error_message)
        except def_error.AuthenticationError as e:
            print("[GENERATE_ERROR] Authentication failed", e)
            error_message = (
            ...
            error_message = (
                "This problem has not occurred before. Please contact the developer to resolve it."
            )
            return await throw_error(error_message)
    ...
    try:
        if should_generate_images:
            ...
            # Replace the content of the generated image with a new method
